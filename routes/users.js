...
router.get('/stock', function (req, res, next) {
  var sql = `SELECT company_code.company_name, company_code.symbol,DATE_FORMAT(symbol_date.date,'%Y/%m/%d') AS date,symbol_data.open,symbol_data.close,symbol_data.high,symbol_data.low,symbol_data.volume,symbol_data.adjclose FROM company_code JOIN symbol_date ON company_code.id = symbol_date.ccid JOIN symbol_data ON symbol_date.id = symbol_data.symbol_dt_id`;
